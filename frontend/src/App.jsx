...
const ReportGenApp = () => {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      const response = await fetch('https://f0a7-34-31-224-215.ngrok-free.app/process', {
        method: 'POST',
        body: formData,
      });
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await fetch('https://f0a7-34-31-224-215.ngrok-free.app/query', {
        method: 'POST',
  ...
  const exportReport = async (format) => {
    ...
    try {
      const response = await fetch(`https://f0a7-34-31-224-215.ngrok-free.app/report/${format}`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
              ...
              <div className="p-6 space-y-6">
                {plotPath && (
                  <div className="rounded-xl overflow-hidden border border-[#2D2B3C] bg-[#1A1825] p-4">
                    <img 
                      src={`https://f0a7-34-31-224-215.ngrok-free.app${plotPath}`} 
                      alt="Analysis Graph" 
